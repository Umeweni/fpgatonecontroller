...
HD_PWD='C:/Users/onyek/baxandall_tonecontroller/baxandall_tonecontroller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audiocontrol.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audiocontrol.tcl
