...
HD_PWD='C:/Users/onyek/baxandall_tonecontroller/baxandall_tonecontroller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log audiocontrol.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source audiocontrol.tcl -notrace
